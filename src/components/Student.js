...
import GedocsEtudiant from './GedocsEtudiant.js';
            ...
            return (
                <div className="profile-form">
                    ...
                    <form>
                        ...
                        <label>Statut:</label>
                        <input type="text" value="Etudiant" readOnly />
                    </form>
                </div>
            );
            ...
            <div className="user-space">
                <div className="left-menu">
                    <ul>
                        ...
                        <li onClick={() => setSelectedTab('Cours')}>Cours</li>
                        <li onClick={() => setSelectedTab('Gedocs')}>demander un document</li>
